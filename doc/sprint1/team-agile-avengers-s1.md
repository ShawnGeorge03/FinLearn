...
- Sprint Planning meeting (sprintN.md) (max 2 marks)
  ...
  > Task breakdown? Who will take care of what?
...
- Is the git commit message clear? (max 2 marks)
  ...
  > Explain what changes are, even if they are minor
...
- Presented more than 2 features along with the user story on Jira
- All group members present, Aryan.T had a midterm, so he could not make it
- Created appropirate documentation
